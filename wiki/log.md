...
- `cargo test`: 3 new real tests pass (hermes: test_pl_delta_attribution_basic, test_gated_wiki_proposal_augmentation_smoke; ui: test_simple_structs_serde_and_defaults). "test result: ok. 3 passed".
